...
class Main extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['genre_id', 'speech_id', 'code_id', 'kanal', 'micf', 'role', 'template_id', 'auto'], 'integer'],
            [['year_sum', 'season_1_sum', 'season_2_sum', 'season_3_sum', 'season_4_sum', 'day_sum', 'month_sum', 'sum'], 'number'],
